...
int main(int argc, char *argv[]){
  ...
  double mu  = 1.;                // CAREFUL NOT TO CHANGE THIS! Or if you do, re-define the normal derivative n, too.
  double eta = 1.;                // CAREFUL NOT TO CHANGE THIS! Or if you do, re-define the normal derivative m, too.
  double mu0 = 1.;
